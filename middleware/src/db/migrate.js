...
async function seedDefaultCompany() {
    ...
    // Em produção, empresas devem ser criadas apenas via Painel Identity (Multi-tenant).
    // O auto-registro é exclusivo para desenvolvimento local.
    if (process.env.NODE_ENV === 'production') {
        logger.info('[Migrate] Ignorando seedDefaultCompany em ambiente de Produção.');
        return;
    }
