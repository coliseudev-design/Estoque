...
BEGIN
    ...
    INSERT INTO PEDIDOS (ID_EMPRESA, ID_PEDIDO, ID_MOBILE, PEDIDO, ID_CLIENTE, ID_ESPECIE, DATA_HORA, ID_FUNCIONARIO, ID_VENDEDOR,
    ...
    VALUES ( :PEMPRESA, :CD_NP, 1, 'MOB'||:CD_MOB, :CLIENTE, :PAGAMENTO, CURRENT_TIMESTAMP, :USUARIO, :USUARIO,
