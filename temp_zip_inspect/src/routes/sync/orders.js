                ...
                try {
                    ...
                    await fbExec(req.company,
                        ...
                        [
                            ...
                            String(order.naturezaId || ''), // 7. TIPO_OPERACAO
                    ...
                    const lastRows = await fbQuery(req.company,
                    ...
                    if (erpIdValue) {
                        ...
                        await fbExec(req.company, 'DELETE FROM PEDIDOS_DOCS WHERE ID_PEDIDO = ?', [erpIdValue]);
