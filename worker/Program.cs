...
try
{
    ...
    Log.Information("[Startup] VPS API: {Url} | Tenant ID: {Tenant} | Atendente: {AtendenteEnabled} | AutoCenter: {AcEnabled} | Dashboard: {DashEnabled} | Nexus: {NexusEnabled} | Vision: {VisionEnabled} | Garantias: {GarantiasEnabled}",
        vpsBaseUrl,
