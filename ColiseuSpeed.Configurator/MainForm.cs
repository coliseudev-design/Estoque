...
namespace ColiseuSpeed.Configurator
{
    ...
    public partial class MainForm : Form
    {
        ...
        private string CurrentWorkerServiceName
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(suffix))
                    return "ColiseuSpeed Worker";
                return $"ColiseuSpeedWorker_{suffix}";
            }
        }
        ...
        private void BuildTrayIcon()
        {
            ...
            mnuStartWorker.Click += (_, _) =>
            {
                try
                {
                    ...
                    {
                        sc.Start();
                        ShowBalloon("Worker iniciado", "O serviço Coliseu Speed Worker está em execução.", ToolTipIcon.Info);
                    }
                }
            ...
            mnuStopWorker.Click += (_, _) =>
            {
                try
                {
                    ...
                    {
                        sc.Stop();
                        ShowBalloon("Worker parado", "O serviço Coliseu Speed Worker foi parado.", ToolTipIcon.Warning);
                    }
                }
                catch (Exception ex) { ShowBalloon("Erro", ex.Message, ToolTipIcon.Error); }
            };
            ...
            {
                Text    = "Coliseu Speed — Worker Monitor",
                Visible = true,
        ...
        private const string TaskName = "Coliseu Speed Worker Monitor";
        ...
        private void InitializeComponent()
        {
            ...
            Text            = $"Coliseu Speed — Worker Configurator v{version}";
            ...
            try
            {
                    ...
                    sc.Status == ServiceControllerStatus.StopPending)
                {
                    ...
                    ShowBalloon("⚠ Worker reiniciado automaticamente",
                        "O serviço Coliseu Speed Worker estava parado e foi reiniciado.",
                        ToolTipIcon.Warning);
        ...
        private async Task EnsureWorkerReadyAsync(bool saveSettings = true)
        {
            ...
            await Task.Run(() =>
            {
                try
                {
                    ...
                    var serviceName = string.IsNullOrEmpty(serviceSuffix) ? "ColiseuSpeed Worker" : $"ColiseuSpeedWorker_{serviceSuffix}";
                    ...
                    if (sc.Status == ServiceControllerStatus.Stopped)
                    {
                        ...
                        ShowBalloon("✅ Worker iniciado",
                            "Coliseu Speed Worker está sincronizando com a VPS.", ToolTipIcon.Info);
                    }
                }
